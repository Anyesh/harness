...
3. Check `document.documentElement.scrollWidth <= innerWidth` at each stop (no horizontal overflow) and confirm text contrast at mid-scroll positions, not just at section rest points.
