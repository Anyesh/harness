...
1. **Context**: What is the project? Where are the specs, plans, and logs? Read the wiki (if it exists), check `graphify-out/GRAPH_REPORT.md` if present, read any existing plans or specs. State what you found.
