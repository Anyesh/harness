#!/bin/bash
# SessionStart hook: detect .wiki-sync-pending and inject context
# telling the agent to run wiki sync on new graph nodes.
...
cat <<EOF
{
  "statusMessage": "Wiki sync pending ($FILE_COUNT files changed)",
